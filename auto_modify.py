...
# Define the indices to keep (0-based)
        ...
        for file in os.listdir(year_path):
            if file.lower().endswith(".csv"):
                ...
                try:
                    ...
                    # Check that there are enough columns before selecting by index.
                    if df.shape[1] < max(cols_to_keep)+1:
                        print(f"    Skipping file because it has fewer columns than expected.")
                        continue
                    ...
                    # (Using str.contains with case-sensitive search; adjust if needed)
                    ...
                    # If conversion fails, the value becomes NaT and then NaN.
